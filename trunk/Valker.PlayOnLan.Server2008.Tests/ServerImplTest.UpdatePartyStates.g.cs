// <copyright file="ServerImplTest.UpdatePartyStates.g.cs" company="Kelman Ltd">Copyright © Kelman Ltd 2011</copyright>
// <auto-generated>
...
public void UpdatePartyStates38901()
{
    using (PexDisposableContext disposables = PexDisposableContext.Create())
    {
      ...
      this.UpdatePartyStates(serverImpl, (IClientInfo)null);
      disposables.Dispose();
    }
}
[TestMethod]
...
[Ignore]
[PexDescription("the test state was: path bounds exceeded")]
public void UpdatePartyStates389()
{
    using (PexDisposableContext disposables = PexDisposableContext.Create())
    {
      ServerImpl serverImpl;
