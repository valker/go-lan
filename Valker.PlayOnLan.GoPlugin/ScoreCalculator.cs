...
//    {
//        public Pair<IPlayer, int>[] Calculate(IPosition position)
//        {
...
//                foreach (Point point in claster)
//                {
//                    foreach (Point neighbour in point.Neighbours(position.Size))
//                    {
//                        var owner = position.GetCellAt(neighbour);
//                        if (owner != Stone.None)
//                        {
//                            if (type == Stone.None)
//                            {
...
//                    if (position.GetCellAt(point) == Stone.None)
//                    {
//                        empties.Add(point);
//                    }
//                }
